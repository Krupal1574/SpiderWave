  ...
  return (
    <div className="h-[96px] w-full bg-surface/95 backdrop-blur-md border-t border-border flex items-center justify-between px-6 select-none relative z-50">
      ...
      <div className="flex items-center gap-4 w-[30%] min-w-[240px]">
        {currentTrack ? (
          <>
            <div className="w-16 h-16 bg-surface-hover rounded-md overflow-hidden flex-shrink-0 shadow-md group relative cursor-pointer border border-border/50">
            ...
            <div className="flex flex-col truncate">
              <span className="text-sm font-bold text-text-primary hover:underline cursor-pointer truncate">
                {currentTrack.title}
              </span>
